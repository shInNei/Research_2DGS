...
trace_bvh_cuda(int32_t num_rays, int32_t* nodes, float* aabbs,
        ...
        thrust::for_each(thrust::device,
                     ...
                     [nodes, aabbs_internal, rays_o, rays_d, num_contributes] __device__ (int32_t idx) -> void
                     {
...
//         float milliseconds = 0;
        ...
        thrust::for_each(thrust::device,
                     ...
                     thrust::make_counting_iterator<int32_t>(num_rays),
                     [nodes, aabbs_internal, rays_o, rays_d, num_contributes,
                     means3D, covs3D, opacities, normals, rendered_opacity] __device__ (int32_t idx) -> void
                     {
                         IndexStack<int32_t> stack_device;
                         stack_device.push(0);
                         int32_t count = 0;
